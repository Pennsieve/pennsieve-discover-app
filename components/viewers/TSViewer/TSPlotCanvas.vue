        ...
        methods: {
                    ...
                    for(let i = 0; i < requests.length; i++) {
                        ...
                        if (ws && ws.readyState === 1 && curRequest.pixelWidth>0) {
                            ...
                            const req = {
                                ...
                                packageId: this.activeViewer.package,
            ...
            sendMontageMessage: function (value) {
                if (this._websocket && this._websocket.readyState === 1) {
                    const payload = { montage: value, packageId: this.activeViewer.package }
            ...
            _onWebsocketOpen: function(e) {
                ...
                if (this.initWebsocket) {
                    ...
                    // clear montage
                    const payload = { montage: 'NOT_MONTAGED', packageId: this.activeViewer.package }
                    this._websocket.send(JSON.stringify(payload))
