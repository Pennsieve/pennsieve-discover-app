<template>
  <div
    class="search-results body-wrap"
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-md-10">
            ...
            <template v-if="datasets.length">
              ...
              <div class="dataset-list-controls-wrap mb-24">
            ...
            <p v-else>Displaying 0 results for “{{ searchQuery }}”</p>
            ...
            <div v-else class="dataset-list">
              ...
              <no-search-results
                ...
                @back="$router.replace({ name: 'index' })"
              />
            </div>

            <div
              v-if="datasets.length"
              class="bottom-pagination-wrap hidden-md-and-up"
            >
              <el-pagination
                v-show="totalDatasetCount > pageSize"
                :page-size="pageSize"
...
export default {
  ...
  computed: {
     ...
     */
    getDatasetsUrl() {
      const url = `${process.env.discover_api_host}/search/datasets?limit=${this.pageSize}&offset=${this.offset}&query=${this.searchQuery}`
    ...
    searchHeading() {
      ...
      const pageRange = this.pageSize * this.page
      const end =
        pageRange < this.totalDatasetCount ? pageRange : this.totalDatasetCount

      const searchHeading = `Displaying ${start}-${end} of ${this.totalDatasetCount} results`

      return this.searchQuery === ''
        ? searchHeading
        : `${searchHeading} for “${this.searchQuery}”`
    },
  ...
  head() {
    return {
      title: 'Search Results - Blackfynn Discover'
    }
  }
}
</script>
